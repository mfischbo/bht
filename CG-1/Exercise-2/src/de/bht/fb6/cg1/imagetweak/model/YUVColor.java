...
public class YUVColor {
	...
	public void setParameters(final int[] parameters) throws IllegalArgumentException {
		...
		if (parameters[0] < 0 || parameters[0] > 255) 
			throw new IllegalArgumentException("The value for the component 'lumina' is out of range [0;255]" + parameters[0]);
		if (parameters[1] < 0 || parameters[1] > 255) 
			throw new IllegalArgumentException("The value for the component 'V-Chroma' is out of range [0;255]" + parameters[1]);
		if (parameters[2] < 0 || parameters[2] > 255) 
			throw new IllegalArgumentException("The value for the component 'U-Chroma' is out of range [0;255]" + parameters[2]);
		*/
	...
	public int[] toRGB() {
		...
		colYUV[1] = this.uChroma;  
		colYUV[2] = this.vChroma;	
